...
public class XYPlotVista extends ApplicationFrame {
	 ...
	 *            the frame title.
	 */
	public XYPlotVista(final String title, final String leyenda, ArrayList<Double> costos) {
	...
	public XYPlotVista(final String title, final String leyenda1, String leyenda2, ArrayList<Costos> costosSA) {
